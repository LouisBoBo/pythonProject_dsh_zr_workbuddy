...
```bash
scripts/plugin.sh --app zr-workbuddy install-feature docs/示例/<id>
scripts/plugin.sh --app zr-workbuddy install-feature docs/示例/dist/<id>.zip
```
