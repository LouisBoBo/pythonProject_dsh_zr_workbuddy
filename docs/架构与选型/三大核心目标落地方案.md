...
| CLI/脚本 | `scripts/plugin.sh … features     | enable                                                                     |
...
| 阶段         | 交付                                                                                      | 工期量级（参考） |
| ---------- | --------------------------------------------------------------------------------------- | -------- |
| **P0**     | `check-features` + 文档化「手工拷贝 + enable」验收清单 + 样例第三方目录（可放 `docs/示例/sample-feature/`） | 小        |
...
- [目录结构与用法说明.md](../产品与口径/目录结构与用法说明.md) 大白话入口
...
| [目录结构与用法说明.md](../产品与口径/目录结构与用法说明.md)                | 日常命令                 |
